...
import may.hamidov.policequiz.ui.QuestionActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startButton.setOnClickListener {
            if (!editTextName.text.isEmpty()) {
                ...
                Toast.makeText(this@MainActivity, "Так трудно ввести хоть 1 символ? Комендаунский...", Toast.LENGTH_LONG).show()
            }
        }
    }
}